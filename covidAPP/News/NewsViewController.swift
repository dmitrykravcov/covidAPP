...
class NewsViewController: UICollectionViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let wellDateFormatter = DateFormatter()
        wellDateFormatter.dateStyle = .medium
        wellDateFormatter.timeStyle = .short
        
        let outputDate: String?
        
        if let dateDate = date {
            outputDate = wellDateFormatter.string(from: dateDate)
        } else {
            outputDate = nil
        }
    ...
    func loadDataForNews() {
        ...
        guard let sessionURL = URL(string: "https://newsapi.org/v2/top-headlines?country=us&apiKey=8815d577462a4195a64f6f50af3ada08&category=health")
        else {return}
